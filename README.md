...
- **Создание конфигураций**: Генерация случайных имен и создание .ovpn файлов
- **Удаление конфигураций**: Интерактивное удаление через inline клавиатуру
- **Ограничения**: Настраиваемый лимит конфигураций на пользователя
- **База данных**: SQLite для хранения информации о пользователях и конфигурациях
...
| `MAX_CONFIGS` | Лимит конфигураций на пользователя | `5` |
...
---|-------------|----------|-------------------
1  | 123456789   | john_doe | 2024-01-15 10:30:00
2  | 987654321   | jane_sm  | 2024-01-15 11:45:00
```
...
---|---------|----------------|------------------------------|-------------------
1  | 1       | fast_tiger_123 | ./.ovpn/fast_tiger_123.ovpn  | 2024-01-15 10:35:00
2  | 1       | cool_wolf_456  | ./.ovpn/cool_wolf_456.ovpn   | 2024-01-15 12:20:00
3  | 2       | smart_eagle_789| ./.ovpn/smart_eagle_789.ovpn | 2024-01-15 11:50:00
```
...
- Настроенный лимит конфигураций предотвращает злоупотребления
